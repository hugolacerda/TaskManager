<div class="jumbotron">
	<h1>Welcome!</h1>
	<p>This user panel has been generated by the FuelPHP Framework.</p>
	<p><a class="btn btn-primary btn-lg" href="http://docs.fuelphp.com">Read the Docs</a></p>
</div>
<div class="row">
	<div class="col-md-4">
		<h2>Get Started</h2>
		<p>The controller generating this page is found at <code>APPPATH/classes/controller/user.php</code>.</p>
		<p>This view can be found at <code>APPPATH/views/user/dashboard.php</code>.</p>
